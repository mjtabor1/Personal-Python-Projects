...
def check_high_score(stats, sb):
    ...
    if stats.score > stats.high_score:  # using stats parameter and then tying the score and high_score onto that
        stats.high_score = stats.score
        sb.prep_high_score()  # called upon the instance sb and the module prep_high_score()
